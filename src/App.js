				...
				params: [
				  {
					...
					rpcUrls: ['https://rinkeby.infura.io/v3/328b63476ec347c7a7106b3053e2ee83'],
				  },
				],
			  });
			} else if(chain === 'ethereum') {
	...
	<div class="containerheader">
	  <div class="logo">
		<a href="https://bountyhunterslodge.com">
		  <img classname="headerlogo" src={logosmall} alt="logo" />
		</a>
	  </div>
	  <div class="menu">
	  ...
	  <section>
          ...
          <Heading3>{data.totalSupply} / {MAX_SUPPLY}</Heading3>
                        ...
                        <div class="mint-spinner p-6 mx-auto mb-6">
                            <div class="input-group input-group-md">
                                <div class="input-group-prepend">
                                    <Button id="input-spinner-left-button" type="button" onClick={decrementMintAmount}><img src={minus} /></Button>
                                </div>
                                <input readonly="" class="form-control" name="amount" value={Amount} />
                                <div class="input-group-append">
                                    <Button id="input-spinner-right-button" type="button" onClick={incrementMintAmount}><img src={plus} /></Button>
                                </div>
                            </div>
                        </div>
